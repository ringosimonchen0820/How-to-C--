// This program uses relational operators to compare a string entered by the user with valid part numbers.
...
int main () 
{
    const double PRICE_A = 249.0,       // Prive for part A
