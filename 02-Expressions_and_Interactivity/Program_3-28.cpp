/*  This program is used by General Crates, Inc. 
    to calculate the volume, cost, customer charge, 
    and profit of a crate of my size. 
    It calculates this data drom user inputm which consists 
...
int main()
{
    ...
    // Calculate the crate's own volume, the cost to produce it, the charge to the customer, and the profit.
